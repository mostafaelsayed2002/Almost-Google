...
public class Indexer extends Thread {
    ...
    static String[] names={"MohamedAboutrika.html", "Mohamed Salah - Wikipedia.html", "Cristiano Ronaldo - Wikipedia.html", "Elon Musk - Wikipedia.html", "Jeff Bezos - Wikipedia.html", "Bernard Arnault - Wikipedia.html", "Google - Wikipedia.html", "CNN.html", "Real Madrid CF - Wikipedia.html", "Lionel Messi - Wikipedia.html"};
    ...
    public static void main(String[] args) {
        ...
        for (Word item : dictionary) {
            ...
            for (Website web : item.websites) {
                ...
                website.put("lastRank", random.nextInt(100) /*web.lastRank*/ );
